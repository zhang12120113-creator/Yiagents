...
_ENV_OVERRIDES = {
    ...
    "TRADINGAGENTS_RISK_ENABLED":            "risk_enabled",
    "TRADINGAGENTS_KELLY_FRACTION":          "kelly_fraction",
    "TRADINGAGENTS_MAX_POSITION":            "max_single_position",
    "TRADINGAGENTS_MAX_SECTOR":              "max_single_sector",
    "TRADINGAGENTS_MAX_DRAWDOWN":            "max_drawdown_hard_stop",
    "TRADINGAGENTS_ATR_STOP_MULT":           "atr_stop_mult",
    ...
    "TRADINGAGENTS_FIN_COT_PROMPTS":         "fin_cot_prompts",
    ...
    "TRADINGAGENTS_KILL_SWITCH":             "kill_switch",
}
...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    # Phase 4: global kill switch (env: TRADINGAGENTS_KILL_SWITCH). Halt = no
